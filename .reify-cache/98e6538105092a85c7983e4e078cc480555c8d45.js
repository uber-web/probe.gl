"use strict";var test;module.link('tape-catch',{default(v){test=v}},0);var mean,std,cv;module.link('@probe.gl/bench/stat-utils',{mean(v){mean=v},std(v){std=v},cv(v){cv=v}},1);/* eslint-disable max-len */
