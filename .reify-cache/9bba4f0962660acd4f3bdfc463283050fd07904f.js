"use strict";module.export({default:()=>diffImages});var fs;module.link('fs',{default(v){fs=v}},0);var PNG;module.link('pngjs',{PNG(v){PNG=v}},1);var pixelmatch;module.link('pixelmatch',{default(v){pixelmatch=v}},2);/* global Buffer */




function diffImages(source1, source2, options = {}) {
