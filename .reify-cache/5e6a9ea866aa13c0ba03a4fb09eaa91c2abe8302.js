"use strict";var test;module.link('tape-catch',{default(v){test=v}},0);var BrowserTestDriver;module.link('@probe.gl/test-utils',{BrowserTestDriver(v){BrowserTestDriver=v}},1);/* global document, window */
