"use strict";module.export({formatTime:()=>formatTime,leftPad:()=>leftPad,rightPad:()=>rightPad,formatValue:()=>formatValue,formatImage:()=>formatImage});// TODO: Currently unused, keeping in case we want it later for log formatting
