"use strict";module.export({default:()=>Stats});var getHiResTimestamp;module.link('../utils/hi-res-timestamp',{default(v){getHiResTimestamp=v}},0);var formatTime;module.link('../utils/formatters',{formatTime(v){formatTime=v}},1);
