"use strict";var Probe,Log;module.link('probe.gl',{default(v){Probe=v},Log(v){Log=v}},0);var test;module.link('tape-catch',{default(v){test=v}},1);var version;module.link('probe.gl/../package.json',{version(v){version=v}},2);/* eslint-disable max-statements */
