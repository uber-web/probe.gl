"use strict";var test;module.link('tape-catch',{default(v){test=v}},0);var getBrowser;module.link('probe.gl/env',{getBrowser(v){getBrowser=v}},1);/* eslint-disable max-len */
